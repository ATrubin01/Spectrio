...
role_name = "spectrio-project-eks-iam-role-staging"
...
eks_cluster_sg_tags = {
  ...
  "kubernetes.io/cluster/spectrio-cluster-staging" = "owned"
  "aws:eks:cluster-name"                 = "spectrio-project-eks-cluster-staging"
}
...
##### EKS Worker nodes #####
node_group_name_01           = "spectrio-project-node-group-01-staging"
node_group_name_02 = "spectrio-project-node-group-02-staging"
...
vpc_name = "spectrio-project-vpc-staging"
igw_name = "spectrio-project-internet-gateway-staging"
pub_rt_name = "spectrio-project-public-route-table-staging"
priv_rt_name = "spectrio-project-private-route-table-staging"
